...
\definecolor{pblue}{HTML}{0395DE}%0395DE color blue previous; FA01DA5C purple; 
...
\begin{aside}
  \section{Tel\includegraphics[scale=0.025]{logos/telefono.png}\&Skype\includegraphics[scale=0.025]{logos/skype.png}}
    ...
    ~
    \section{StackOverFlow}\includegraphics[scale=0.028]{logos/stack-overflow.png}
...
\begin{flushleft}
\emph{ July 27, 2021; Donovan Riaño Enriquez}
\end{flushleft}
